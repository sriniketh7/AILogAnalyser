...
public class GeminiAIAnalysisService implements AIAnalysisService {
    ...
    public GeminiAIAnalysisService(ChatClient chatClient, PromptBuilder promptBuilder, AiParser parser, RAGService ragService, MetricService metricsService) {
    ...
    @Override
    public AIAnalysisResponse analyzeStackTrace(String rawLog,List<CodeSnippet> codeSnippets) {
